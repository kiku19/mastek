...
var para1 = [
  "Winner of INDIA 5000 Best MSME Awards for quality excellence with privilege this has been awarded to MASTEK ENGINEERING Pvt.ltd in 2018 for outstanding contribution in quality and excellence.",
  "MASTEK ENGINEERING had been audited and confirmed to ISO 9001:2015 for the following activities Civil, Mechanical and Electrical Construction works for industries including Oil and Gas fields. This can verified by using Certificate number 733014.",
...
loop = async () => {
  for (; i < imgurl.length; i++) {
    ...
    award[0].innerHTML = award[0].textContent.replace(
      /\S/g,
